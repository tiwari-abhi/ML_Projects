...
if __name__ == '__main__':
    # luigi.build([download_data(),preprocess_data(),train_models(),upload_to_s3(AWS_ACCESS_KEY_ID='AKIAJC7LD5P627PQTSAQ',AWS_SECRET_ACCESS_KEY='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',inputLocation='APNortheast')],local_scheduler=True)
    luigi.run()